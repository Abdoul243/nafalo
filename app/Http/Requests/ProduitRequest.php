...
class ProduitRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $isFormation = in_array($this->input('format'), ['formation', 'licence', 'bundle', 'communaute', 'coaching']);
        ...
        return [
            ...
            'format'                => 'nullable|in:fichier,formation,licence,bundle,communaute,coaching',
