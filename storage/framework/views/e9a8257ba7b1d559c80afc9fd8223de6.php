...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Administration'); ?> - <?php echo e(config('app.name')); ?></title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/nafalo-logo.png')); ?>">
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('images/nafalo-logo.png')); ?>">
...
<div id="sidebar-wrapper">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-logo">
        <div class="logo-icon"><img src="<?php echo e(asset('images/nafalo-logo.png')); ?>" alt="Nafalo"></div>
        <span class="sidebar-logo-text"><?php echo e(config('app.name', 'Nafalo')); ?></span>
    </a>
    ...
    <div class="sidebar-boutique dropdown" data-bs-toggle="dropdown">
        <div class="b-avatar">
            <?php if($boutiqueCourante?->logo): ?>
                <img src="<?php echo e(asset('storage/' . $boutiqueCourante->logo)); ?>" alt="">
            <?php else: ?>
                <?php echo e(strtoupper(substr($boutiqueCourante?->nom ?? 'B', 0, 1))); ?>

            <?php endif; ?>
        </div>
        <span class="b-name sidebar-text"><?php echo e($boutiqueCourante?->nom ?? 'Ma boutique'); ?></span>
        <i class="fas fa-chevron-down boutique-chevron sidebar-text"></i>
    </div>
    <ul class="dropdown-menu ms-2" style="min-width:210px;">
        <?php $__currentLoopData = $boutiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li><a class="dropdown-item" href="<?php echo e(route('admin.boutiques.select', $b->id)); ?>">
            <div style="width:22px;height:22px;border-radius:5px;background:#eff6ff;display:flex;align-items:center;justify-content:center;font-size:0.65rem;font-weight:700;color:#2563eb;flex-shrink:0;"><?php echo e(strtoupper(substr($b->nom,0,1))); ?></div>
            <?php echo e($b->nom); ?>

            <?php if(session('boutique_id')==$b->id): ?><i class="fas fa-check ms-auto" style="color:#22c55e;"></i><?php endif; ?>
        </a></li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <li><hr class="dropdown-divider my-1"></li>
        <li><a class="dropdown-item" href="<?php echo e(route('admin.boutiques.create')); ?>"><i class="fas fa-plus" style="color:#2563eb;"></i> Créer une boutique</a></li>
    </ul>

    <nav class="sidebar-nav">
        <div class="nav-item">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(isActiveRoute('admin.dashboard')); ?>">
                <i class="fas fa-home"></i><span class="sidebar-text">Accueil</span>
            </a>
        </div>
        <div class="sidebar-section-label sidebar-text">Boutique</div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.produits.index')); ?>" class="<?php echo e(isActiveRoute('admin.produits.*')); ?>">
                <i class="fas fa-box"></i><span class="sidebar-text">Produits</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.clients.index')); ?>" class="<?php echo e(isActiveRoute('admin.clients.*')); ?>">
                <i class="fas fa-users"></i><span class="sidebar-text">Clients</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.transactions.index')); ?>" class="<?php echo e(isActiveRoute('admin.transactions.*')); ?>">
                <i class="fas fa-wallet"></i><span class="sidebar-text">Revenus</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.statistiques.ventes')); ?>" class="<?php echo e(isActiveRoute('admin.statistiques.*')); ?>">
        ...
        <div class="nav-item">
            <a href="<?php echo e(route('admin.codes-promo.index')); ?>" class="<?php echo e(isActiveRoute('admin.codes-promo.*')); ?>">
                <i class="fas fa-percent"></i><span class="sidebar-text">Réductions</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.pixels.index')); ?>" class="<?php echo e(isActiveRoute('admin.pixels.*')); ?>">
                <i class="fas fa-bullseye"></i><span class="sidebar-text">Pixels</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.avis.index')); ?>" class="<?php echo e(isActiveRoute('admin.avis.*')); ?>">
                <i class="fas fa-star"></i><span class="sidebar-text">Avis</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.copublications.index')); ?>" class="<?php echo e(isActiveRoute('admin.copublications.*')); ?>"
               style="position:relative;">
                ...
                ?>
                <?php if($nbInvitCopub > 0): ?>
                    <span class="badge bg-warning text-dark ms-1" style="font-size:0.65rem;padding:2px 6px;"><?php echo e($nbInvitCopub); ?></span>
                <?php endif; ?>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.kyc.index')); ?>" class="<?php echo e(isActiveRoute('admin.kyc.*')); ?>" style="position:relative;">
        ...
        <div class="nav-item">
            <a href="<?php echo e(route('admin.configurations.general')); ?>" class="<?php echo e(isActiveRoute('admin.configurations.general') ?: isActiveRoute('admin.configurations.paiement') ?: isActiveRoute('admin.configurations.email') ?: ''); ?>">
                <i class="fas fa-cog"></i><span class="sidebar-text">Paramètres</span>
            </a>
        </div>
        <div class="nav-item">
            <a href="<?php echo e(route('admin.configurations.apparence')); ?>" class="<?php echo e(isActiveRoute('admin.configurations.apparence')); ?>">
    ...
    <div class="sidebar-footer">
        <div class="sf-avatar"><?php echo e(strtoupper(substr(Auth::user()->nom ?? 'A', 0, 1))); ?></div>
        <div class="sidebar-footer-info sidebar-text">
            <div class="sf-name"><?php echo e(Auth::user()->nom); ?></div>
            <div class="sf-email"><?php echo e(Auth::user()->email); ?></div>
        </div>
    </div>
</div>
        ...
        <div class="topbar-left">
            ...
            <div class="dropdown">
                <div class="tb-boutique" data-bs-toggle="dropdown">
                    ...
                    <span class="tb-b-name"><?php echo e($boutiqueCourante?->nom ?? 'Ma boutique'); ?></span>
                ...
                <ul class="dropdown-menu" style="min-width:210px;">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <li><hr class="dropdown-divider my-1"></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.boutiques.choisir')); ?>"><i class="fas fa-exchange-alt" style="color:#2563eb;"></i> Changer de boutique</a></li>
                </ul>
            </div>
        </div>
        <div class="topbar-right">
            <?php if($boutiqueCourante): ?>
            <a href="<?php echo e(url('/boutique')); ?>" target="_blank" class="btn-visit-store">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end notif-dropdown" id="notif-dropdown">
                    ...
                    <div style="padding:0.6rem 1rem;border-top:1px solid #f1f5f9;text-align:center;">
                        <a href="<?php echo e(route('admin.notifications.index')); ?>" style="font-size:0.78rem;color:#2563eb;text-decoration:none;font-weight:600;">Voir toutes les notifications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown">
                <button class="user-menu-btn" data-bs-toggle="dropdown">
                    <div class="u-avatar"><?php echo e(strtoupper(substr(Auth::user()->nom ?? 'A', 0, 1))); ?></div>
                    <span class="u-name d-none d-md-inline"><?php echo e(Auth::user()->nom); ?></span>
                    <i class="fas fa-chevron-down" style="font-size:0.6rem;color:#94a3b8;"></i>
                </button>
                <ul class="dropdown-menu dropdown-menu-end" style="min-width:190px;">
                    <li><div class="px-3 py-2" style="font-size:0.72rem;color:#94a3b8;"><?php echo e(Auth::user()->email); ?></div></li>
                    <li><hr class="dropdown-divider my-1"></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('admin.configurations.general')); ?>"><i class="fas fa-cog"></i> Paramètres</a></li>
                    <li><hr class="dropdown-divider my-1"></li>
                    <li>
...
(function() {
    ...
    function chargerNotifications() {
        fetch('<?php echo e(route("admin.notifications.recentes")); ?>')
    ...
    window.marquerToutesLues = function() {
        fetch('<?php echo e(route("admin.notifications.toutes-lues")); ?>', {
            method: 'POST',
            headers: { 'X-CSRF-TOKEN': csrfToken, 'Accept': 'application/json' }
...
</html><?php /**PATH C:\laragon\www\digital-store\resources\views/layouts/admin.blade.php ENDPATH**/ ?>