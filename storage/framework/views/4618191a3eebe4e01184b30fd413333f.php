...
<body>
    <div class="selector-card position-relative">
        ...
        <a href="<?php echo e(route('admin.boutiques.select', $boutique->id)); ?>" class="boutique-item">
            <div class="boutique-avatar">
                <?php if($boutique->logo): ?>
                    <img src="<?php echo e(asset('storage/' . $boutique->logo)); ?>" alt="<?php echo e($boutique->nom); ?>">
                <?php else: ?>
                    <?php echo e(strtoupper(substr($boutique->nom, 0, 1))); ?>

                <?php endif; ?>
            </div>
            <div class="boutique-info">
                <div class="boutique-name"><?php echo e($boutique->nom); ?></div>
                <div class="boutique-domain">
                    <?php echo e($boutique->domaine_personnalise ?? 'digital-store.test'); ?>

                </div>
            </div>
            <?php if(session('boutique_id') == $boutique->id): ?>
        ...
        <a href="<?php echo e(route('admin.boutiques.create')); ?>" class="btn-create">
            <i class="fas fa-plus"></i> Créer une boutique
        </a>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\digital-store\resources\views/admin/boutiques/select.blade.php ENDPATH**/ ?>