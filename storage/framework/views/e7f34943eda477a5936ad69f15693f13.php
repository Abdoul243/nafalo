...
<nav id="navbar">
    <a href="/" class="nav-logo">
        <img src="<?php echo e(asset('images/nafalo-logo.png')); ?>" alt="Nafalo">
    </a>
    <div class="nav-links">
...
<section class="testimonials-section" id="temoignages">
    ...
    <div class="carousel-track-wrapper">
        <div class="carousel-track" id="carousel">
            ...
            ?>
            <?php $__currentLoopData = array_merge($temoignages, $temoignages); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="tcard">
                <div class="tcard-stars">★★★★★</div>
                <p class="tcard-text">"<?php echo e($t[4]); ?>"</p>
                <div class="tcard-author">
                    <div class="tcard-avatar" style="background:<?php echo e($t[3]); ?>"><?php echo e($t[0]); ?></div>
                    <div>
                        <div class="tcard-name"><?php echo e($t[1]); ?></div>
                        <div class="tcard-role"><?php echo e($t[2]); ?></div>
                    </div>
                </div>
            </div>
    ...
    <div class="footer-inner">
        <div class="footer-grid">
            <div class="footer-brand">
                <img src="<?php echo e(asset('images/nafalo-logo.png')); ?>" alt="Nafalo" style="height:80px;width:auto;mix-blend-mode:screen;filter:brightness(1.5);">
            ...
            <div class="footer-col">
                <h5>Légal</h5>
                <a href="<?php echo e(route('legal.conditions')); ?>">Conditions d'utilisation</a>
                ...
                <a href="<?php echo e(route('legal.remboursement')); ?>">Remboursements</a>
                <a href="<?php echo e(route('legal.contact')); ?>">Contact</a>
            </div>
        </div>
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> Nafalo. Tous droits réservés.</p>
...
<div class="modal-overlay" id="modal" onclick="closeModalOutside(event)">
    <div class="modal-box" style="position:relative;">
        ...
        <div class="modal-logo"><img src="<?php echo e(asset('images/nafalo-logo.png')); ?>" alt="Nafalo"></div>
        <div class="modal-title">Bienvenue sur Nafalo</div>
        <div class="modal-sub">Connectez-vous ou créez votre boutique</div>

        <?php if(session('status')): ?>
            <div class="alert-box alert-success"><i class="fas fa-check-circle"></i> <?php echo e(session('status')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="alert-box alert-danger"><i class="fas fa-exclamation-circle"></i> <?php echo e($errors->first()); ?></div>
        <?php endif; ?>
        ...
        <div class="auth-form active" id="form-login">
            <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                <?php echo csrf_field(); ?>
                <div class="field"><label>Email</label><input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="vous@exemple.com" required autofocus></div>
                ...
                <div class="field-row">
                    ...
                    <a href="<?php echo e(route('admin.password.request')); ?>" class="forgot">Mot de passe oublié ?</a>
                </div>
        ...
        <div class="auth-form" id="form-register">
            <form method="POST" action="<?php echo e(route('admin.register')); ?>">
                <?php echo csrf_field(); ?>
                <div class="field"><label>Nom complet</label><input type="text" name="nom" value="<?php echo e(old('nom')); ?>" placeholder="Ex : Aminata Diallo" required></div>
                <div class="field"><label>Adresse email</label><input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="vous@exemple.com" required></div>
                <div class="field"><label>Nom de votre boutique</label><input type="text" name="nom_boutique" value="<?php echo e(old('nom_boutique')); ?>" placeholder="Ex : Ma Boutique Digitale" required></div>
...
<?php if($errors->any() || session('status') || session('success')): ?>
    document.addEventListener('DOMContentLoaded', () => {
        <?php if(old('nom') || old('nom_boutique')): ?>
            openModal('register');
        <?php else: ?>
            openModal('login');
        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\digital-store\resources\views/auth/admin/login.blade.php ENDPATH**/ ?>