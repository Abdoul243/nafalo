...
<style>
    ...
    .produit-check:checked + .produit-label::before {
        content: '✓'; color: #2563eb; font-weight: 800; margin-right: 2px;
    }
    ...
    .preview-badge { background: #22c55e; color: white; padding: 0.4rem 0.9rem; border-radius: 20px; font-size: 0.8rem; font-weight: 700; }
</style>

{{-- Header --}}
<div class="d-flex justify-content-between align-items-center promo-header">
    <div>
        <h1>🏷️ Créer un code promo</h1>
        <p>Configurez une réduction pour vos clients</p>
    </div>
...
<div class="promo-preview">
    <div>
        <div class="preview-label">Aperçu du code</div>
...
<div class="promo-grid">
    ...
    <div class="promo-card">
        <div class="card-section-title">
            <i class="fas fa-tag"></i> Informations du code
        </div>
        ...
        <div class="field-group">
            ...
            <div class="input-wrap">
                ...
                <input type="text" class="promo-input @error('code') is-invalid @enderror"
                       ...
                       placeholder="Ex : SUMMER20" required
                       oninput="document.getElementById('preview-code').textContent = this.value.toUpperCase() || 'MONCODE'"
        ...
        <div class="field-group">
            ...
            <div class="input-wrap">
                ...
                <span class="input-suffix" id="suffix-label">FCFA</span>
            </div>
    ...
    {{-- Colonne droite : validité --}}
    <div class="promo-card">
        <div class="card-section-title">
            <i class="fas fa-calendar-alt"></i> Validité & Limites
        </div>
    ...
    <div class="promo-card promo-card-full">
        <div class="card-section-title">
            <i class="fas fa-boxes"></i> Produits concernés
        </div>
...
<div style="display:flex; align-items:center; gap:1rem; flex-wrap:wrap;">
    <button type="submit" class="btn-promo-submit">
        <i class="fas fa-check"></i> Créer le code promo
    </button>
...
<script>
// Mise à jour du suffixe selon le type
