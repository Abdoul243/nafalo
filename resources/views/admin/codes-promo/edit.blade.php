...
<style>
    ...
    .card-section-title { display: flex; align-items: center; gap: 10px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; color: #2563eb; margin-bottom: 1.25rem; padding-bottom: 0.75rem; border-bottom: 1px solid #f1f5f9; }
    ...
    .type-option:checked + .type-label { border-color: #2563eb; background: #eff6ff; box-shadow: 0 0 0 3px rgba(37,99,235,0.08); }
    ...
    .produit-check:checked + .produit-label { border-color: #2563eb; background: #eff6ff; color: #1d4ed8; font-weight: 600; }
    .produit-check:checked + .produit-label::before { content: '✓'; color: #2563eb; font-weight: 800; margin-right: 2px; }
    ...
    .btn-promo-submit { display: inline-flex; align-items: center; gap: 8px; padding: 0.85rem 2rem; background: linear-gradient(135deg, #2563eb, #1d4ed8); color: white; border: none; border-radius: 12px; font-weight: 700; font-size: 0.95rem; cursor: pointer; transition: all 0.2s; font-family: inherit; box-shadow: 0 4px 14px rgba(37,99,235,0.3); }
...
<div class="d-flex justify-content-between align-items-center promo-header">
    <div>
        <h1>✏️ Modifier le code promo</h1>
