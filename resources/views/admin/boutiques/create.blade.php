        ...
        <form action="{{ route('admin.boutiques.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('domaine_personnalise') is-invalid @enderror" 
                       ...
                       value="{{ old('domaine_personnalise') }}" placeholder="exemple.com">
                ...
                <div id="socials-container">
                    <div class="input-group mb-2">
                        ...
                        <input type="url" class="form-control" name="reseaux_sociaux[facebook]" 
                               placeholder="URL Facebook" value="{{ old('reseaux_sociaux.facebook') }}">
                    </div>
                    <div class="input-group mb-2">
                        <span class="input-group-text"><i class="fab fa-twitter"></i></span>
                        <input type="url" class="form-control" name="reseaux_sociaux[twitter]" 
                               placeholder="URL Twitter" value="{{ old('reseaux_sociaux.twitter') }}">
                    </div>
                    <div class="input-group mb-2">
                        <span class="input-group-text"><i class="fab fa-instagram"></i></span>
                        <input type="url" class="form-control" name="reseaux_sociaux[instagram]" 
                               placeholder="URL Instagram" value="{{ old('reseaux_sociaux.instagram') }}">
                    </div>
                </div>
            </div>
            
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="est_active" name="est_active" value="1" checked>
                <label class="form-check-label" for="est_active">Boutique active</label>
            </div>
            
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i>Créer la boutique
                </button>
            </div>
        </form>
    </div>
