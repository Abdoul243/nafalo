...
{{-- Copier le lien --}}
<a href="#" onclick="copyLink('{{ url('/boutique/produits/' . $produit->slug) }}'); return false;">
...
{{-- Publier / Dépublier --}}
<button onclick="togglePublier({{ $produit->id }})">
...
{{-- Supprimer --}}
<button class="danger" onclick="confirmDelete({{ $produit->id }}, '{{ addslashes($produit->nom) }}')">
