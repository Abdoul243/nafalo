...
return [
    ...
    'attributes' => [
        ...
        'utilisation_max' => 'utilisation maximum',
        'code_pixel' => 'code pixel',
        'emplacement' => 'emplacement',
        'note' => 'note',
        'commentaire' => 'commentaire',
        'quantite' => 'quantité',
        'categorie_id' => 'catégorie',
        'domaine_personnalise' => 'domaine personnalisé',
        'passerelle_paiement' => 'passerelle de paiement',
        'cle_api_paiement' => 'clé API',
        'secret_api_paiement' => 'secret API',
        'devise' => 'devise',
        'email_expediteur' => 'email expéditeur',
        'relance_delai_jours' => 'délai de relance',
    ],
];